...
![第01章_JVM所处位置](/img/JVM/image-20211014224943685.png)
...
![第02章_JVM架构-简图](/img/JVM/image-20211014225552572.png)

## Java代码执行流程

凡是能生成被Java虚拟机所能解释、运行的字节码文件，那么理论上我们就可以自己设计一套语言了

![image-20211014225516400](/img/JVM/image-20211014225516400.png)
